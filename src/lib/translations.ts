...
export const translations = {
    en: {
        ...
        editor: {
            ...
            tagsAiGenerate: "AI Generate",
            tagsGenerating: "Generating…",
            tagsAiError: "Failed to generate knowledge tags",
        ...
        settings: {
            ...
            prompts: {
                ...
                vars: {
                    ...
                    subject: "Subject of the question (e.g. Math/Physics), inferred from the notebook name.",
                    gradeSemester: "Grade and semester of the student (e.g. Grade 8, 2nd semester).",
                    questionText: "The question content.",
                    answerText: "The answer content (may be empty).",
                    analysis: "The analysis/explanation content (may be empty).",
                }
            },
            messages: {
    ...
    zh: {
        ...
        settings: {
            ...
            prompts: {
                ...
                analysisTab: "题目分析提示词",
                similarTab: "举一反三提示词",
                knowledgeTagsTab: "知识点标签",
                customAnalysis: "自定义分析提示词模板",
                customSimilar: "自定义举一反三模板",
                customKnowledgeTags: "自定义知识点标签模板",
                reset: "恢复默认",
                ...
                vars: {
                    ...
                    subject: "题目学科（如 数学/物理），由错题本名称自动推断。",
                    gradeSemester: "学生所在年级学期（如 八年级下）。",
                    questionText: "题目内容。",
                    answerText: "答案内容（可能为空）。",
                    analysis: "解析内容（可能为空）。",
                }
            },
            messages: {
